        ...
        [
          {
            ...
            config: {
              ...
              label: t('Layout Mode'),
              description: t(
                'Fit to Screen natively squeezes the calendar into the dashboard widget. Scrollable applies a strictly fixed Cell Size and triggers a scrollbar if the widget is too small.',
              ),
              default: 'scrollable',
              choices: [
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Display the metric value inside each calendar cell.',
              ),
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Display the day-of-month number as subscript text in each calendar cell.',
              ),
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Continuous gradient or piecewise (discrete steps).',
              ),
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Minimum value for the color scale. Leave empty to auto-detect.',
              ),
              default: '',
              isFloat: true,
              renderTrigger: true,
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Maximum value for the color scale. Leave empty to auto-detect.',
              ),
              default: '',
              isFloat: true,
              renderTrigger: true,
        ...
        [
          {
            ...
            config: {
              ...
              description: t(
                'Temporal mode overrides the global Time Range on connected charts (Superset default behaviour). Categorical mode generates a raw string filter that skips temporal parsing and can be intercepted by SQL Jinja templates.',
              ),
              default: 'temporal',
              choices: [
