...
import {
  CustomDatePickerFormData,
  CustomDatePickerTransformedProps,
} from '../types';

export default function transformProps(
  chartProps: ChartProps,
): CustomDatePickerTransformedProps {
  const { formData, height, width, hooks, queriesData, filterState, theme } =
    chartProps;
  ...
  const {
    ...
    defaultStaticValue,
    defaultDynamicValue,
  } = formData as CustomDatePickerFormData;
